...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/umarzahid/www/trevinosauto/public/storage' => 'string',
...
'filesystems.links./Users/umarzahid/www/trevinosauto/public/storage','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'signed','throttle','verified','approve.estimates',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','telescope','transports.track','dashboard',
'profile.edit','profile.update','profile.destroy','vehicles.index','vehicles.create',
'vehicles.store','vehicles.show','vehicles.edit','vehicles.update','vehicles.destroy',
'transports.index','transports.create','transports.store','transports.show','transports.edit',
'transports.update','transports.destroy','transports.batch','transports.batch.acknowledge','transports.update-status',
'transports.batch.update-status','transporters.index','transporters.create','transporters.store','transporters.show',
'transporters.edit','transporters.update','transporters.destroy','vendors.index','vendors.create',
'vendors.store','vendors.show','vendors.edit','vendors.update','vendors.destroy',
'vendors.toggle-active','vendor-types.index','vendor-types.create','vendor-types.store','vendor-types.edit',
'vendor-types.update','vendor-types.toggle-active','vendor-estimates.store','vendor-estimates.approve','vendor-estimates.reject',
'vendor-estimates.pending','inspection.stages.index','inspection.stages.create','inspection.stages.store','inspection.stages.show',
'inspection.stages.edit','inspection.stages.update','inspection.stages.destroy','inspection.stages.reorder','inspection.stages.toggle-active',
'inspection.items.index','inspection.items.create','inspection.items.store','inspection.items.show','inspection.items.edit',
'inspection.items.update','inspection.items.destroy','inspection.items.toggle-active','inspection.inspections.index','inspection.inspections.create',
'inspection.inspections.show','inspection.inspections.edit','inspection.inspections.update','inspection.inspections.destroy','inspection.inspections.store',
'inspection.inspections.update-items','inspection.inspections.upload-images','inspection.inspections.delete-image','inspection.vehicles.start-inspection','inspection.inspections.complete',
'inspection.comprehensive.show','inspection.comprehensive.store','inspection.results.store','inspection.results.update','inspection.results.destroy',
'inspection.results.assign-vendor','inspection.results.mark-complete','inspection.results.upload-photo','sales-team.dashboard','sales-team.index',
'sales-team.create','sales-team.store','sales-team.show','sales-team.edit','sales-team.update',
'sales-team.destroy','sales-team.toggle-active','sales.issues.index','sales.issues.create','sales.issues.store',
'sales.issues.show','sales.issues.edit','sales.issues.update','sales.issues.destroy','sales.issues.update-status',
'sales.issues.update-priority','sales.goodwill-claims.index','sales.goodwill-claims.create','sales.goodwill-claims.store','sales.goodwill-claims.show',
'sales.goodwill-claims.edit','sales.goodwill-claims.update','sales.goodwill-claims.destroy','sales.goodwill-claims.update-status','sales.goodwill-claims.update-consent',
'admin.settings.index','admin.settings.update-csv-settings','admin.users.index','admin.users.create','admin.users.store',
'admin.users.show','admin.users.edit','admin.users.update','admin.users.destroy','admin.roles.index',
'admin.roles.create','admin.roles.store','admin.roles.show','admin.roles.edit','admin.roles.update',
'admin.roles.destroy','admin.permissions.index','admin.permissions.create','admin.permissions.store','admin.permissions.show',
'admin.permissions.edit','admin.permissions.update','admin.permissions.destroy','admin.settings.update','admin.activity-log.index',
'admin.system-settings.index','admin.system-settings.update','notifications.index','notifications.mark-as-read','notifications.mark-all-read',
'dashboard.manager','dashboard.transporter','dashboard.vendor','vendor.','vendor.dashboard',
'vendor.inspection-history','vendor.inspections.show','vendor.inspections.submit-estimate','vendor.inspections.update-status','vendor.inspections.index',
'vendor.inspections.show','vendor.inspections.update-item','vendor.inspections.upload-images','repair-images.destroy','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','storage.local',);
        registerArgumentsSet('views', 
'admin.activity-log.index','admin.settings.index','admin.system-settings.index','auth.confirm-password','auth.forgot-password',
'auth.login','auth.register','auth.reset-password','auth.verify-email','components.application-logo',
'components.auth-session-status','components.button','components.button-link','components.danger-button','components.dropdown',
'components.dropdown-link','components.heroicon-o-arrow-left','components.heroicon-o-document-arrow-down','components.heroicon-o-document-check','components.heroicon-o-document-minus',
'components.heroicon-o-document-plus','components.heroicon-o-document-text','components.heroicon-o-eye','components.heroicon-o-magnifying-glass','components.heroicon-o-pencil',
'components.heroicon-o-plus','components.heroicon-o-trash','components.heroicon-o-truck','components.heroicon-o-x-mark','components.input',
'components.input-error','components.input-label','components.inspection-item-image-upload','components.modal','components.nav-link',
'components.notification-dropdown','components.password-input','components.primary-button','components.responsive-nav-link','components.sales-team.form',
'components.searchable-multi-select','components.secondary-button','components.select','components.shadcn.button','components.shadcn.input',
'components.shadcn.select','components.sidebar','components.text-input','components.ui-badge','components.ui-button',
'components.ui-card','components.ui-table','components.ui.card','dashboard','dashboards.manager',
'dashboards.transporter','dashboards.vendor','inspection.inspections.comprehensive','inspection.inspections.create','inspection.inspections.edit',
'inspection.inspections.index','inspection.inspections.show','inspection.items.create','inspection.items.edit','inspection.items.index',
'inspection.items.show','inspection.partials.photo-upload','inspection.partials.vendor-assignment','inspection.stages.create','inspection.stages.edit',
'inspection.stages.index','inspection.stages.show','layouts.app','layouts.guest','layouts.navigation',
'manager.inspections.index','manager.inspections.show','notifications.index','profile.edit','profile.partials.delete-user-form',
'profile.partials.update-password-form','profile.partials.update-profile-information-form','roles.index','sales-team.create','sales-team.dashboard',
'sales-team.edit','sales-team.form','sales-team.index','sales-team.show','sales.goodwill-claims.create',
'sales.goodwill-claims.index','sales.goodwill-claims.show','sales.issues.create','sales.issues.index','sales.issues.show',
'settings.index','transporters.create','transporters.edit','transporters.index','transporters.show',
'transports.batch','transports.create','transports.edit','transports.index','transports.show',
'transports.track','users.create','users.edit','users.index','vehicles.create',
'vehicles.edit','vehicles.index','vehicles.show','vendor-estimates.pending','vendor-types.create',
'vendor-types.edit','vendor-types.index','vendor.dashboard','vendor.inspection-details','vendor.inspection-history',
'vendor.inspections.index','vendor.inspections.show','vendors.create','vendors.edit','vendors.index',
'vendors.show','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'VITE_PUSHER_SCHEME','VITE_PUSHER_APP_CLUSTER','TELESCOPE_ENABLED','TELESCOPE_PATH','TELESCOPE_DRIVER',);
